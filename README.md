# Disclaimer
All credits go to the original author of this tool. I just forked it to make it work with Python 3. I also added a few features to make it more useful for my needs.
Creator: https://github.com/internetwache/GitTools/
